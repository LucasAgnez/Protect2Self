...
// Omit to hide them:
//
// interface MiniaturaGrupoProps extends Omit<DefaultMiniaturaGrupoProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function MiniaturaGrupo_(
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicMiniaturaGrupo are:
  // 1. Variants you want to activate,
  // 2. Contents for slots you want to fill,
  // 3. Overrides for any named node in the component to attach behavior and data,
  // 4. Props to set on the root node.
  //
  // By default, we are just piping all MiniaturaGrupoProps here, but feel free
  // to do whatever works for you.

  return <PlasmicMiniaturaGrupo root={{ ref }} {...props} />;
}

const MiniaturaGrupo = React.forwardRef(MiniaturaGrupo_);
export default MiniaturaGrupo;
