...
// Omit to hide them:
//
// interface NotificacaoProps extends Omit<DefaultNotificacaoProps, "hideProps1"|"hideProp2"> {
//   // etc.
// }
//
...
function Notificacao_(props: NotificacaoProps, ref: HTMLElementRefOf<"div">) {
  ...
  // fetch data.
  //
  // Props you can pass into PlasmicNotificacao are:
  // 1. Variants you want to activate,
  // 2. Contents for slots you want to fill,
  // 3. Overrides for any named node in the component to attach behavior and data,
  // 4. Props to set on the root node.
  //
  // By default, we are just piping all NotificacaoProps here, but feel free
  // to do whatever works for you.

  return <PlasmicNotificacao root={{ ref }} {...props} />;
}

const Notificacao = React.forwardRef(Notificacao_);
