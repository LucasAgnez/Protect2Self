...
export type ThumbDownSvgrepoCom2SvgIconProps = React.ComponentProps<"svg"> & {
  title?: string;
};

export function ThumbDownSvgrepoCom2SvgIcon(
  props: ThumbDownSvgrepoCom2SvgIconProps
) {
...
export default ThumbDownSvgrepoCom2SvgIcon;
/* prettier-ignore-end */
