...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: GCwuU6qoD9h/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: JvLnzcKYZbb/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__lpuM1)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__lcvVw)}
              />
            </React.Fragment>
          ),
          value: args.children
