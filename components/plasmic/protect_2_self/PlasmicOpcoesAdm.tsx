...
import OpcoesAdm__Overlay from "../../OpcoesAdm__Overlay"; // plasmic-import: 0hjy5fl7cOe/component
import OpcoesAdm__Option from "../../OpcoesAdm__Option"; // plasmic-import: BdQJvqA4IgO/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_protect_2_self.module.css"; // plasmic-import: 8XuJZfnuNd7UvNkkshapC6/projectcss
import sty from "./PlasmicOpcoesAdm.module.css"; // plasmic-import: d9qSkDAT15Y/css
...
export type PlasmicOpcoesAdm__VariantMembers = {
  showPlaceholder: "showPlaceholder";
  isOpen: "isOpen";
  isDisabled: "isDisabled";
};

export type PlasmicOpcoesAdm__VariantsArgs = {
  showPlaceholder?: SingleBooleanChoiceArg<"showPlaceholder">;
  isOpen?: SingleBooleanChoiceArg<"isOpen">;
  isDisabled?: SingleBooleanChoiceArg<"isDisabled">;
};

type VariantPropType = keyof PlasmicOpcoesAdm__VariantsArgs;
export const PlasmicOpcoesAdm__VariantProps = new Array<VariantPropType>(
  "showPlaceholder",
  "isOpen",
  "isDisabled"
);

export type PlasmicOpcoesAdm__ArgsType = {
...
type ArgPropType = keyof PlasmicOpcoesAdm__ArgsType;
export const PlasmicOpcoesAdm__ArgProps = new Array<ArgPropType>(
  "selectedContent",
  "placeholder",
  "children",
  "value",
...
export type PlasmicOpcoesAdm__OverridesType = {
  root?: p.Flex<"div">;
  trigger?: p.Flex<"button">;
  contentContainer?: p.Flex<"div">;
  dropdownIcon?: p.Flex<"svg">;
  overlay?: p.Flex<typeof OpcoesAdm__Overlay>;
  optionsContainer?: p.Flex<"div">;
};

export interface DefaultOpcoesAdmProps extends pp.BaseSelectProps {
  "aria-label"?: string;
  "aria-labelledby"?: string;
  slot?: React.ReactNode;
}

const PlasmicOpcoesAdmContext = React.createContext<
  | undefined
  | {
      variants: PlasmicOpcoesAdm__VariantsArgs;
      args: PlasmicOpcoesAdm__ArgsType;
    }
>(undefined);

function PlasmicOpcoesAdm__RenderFunc(props: {
  variants: PlasmicOpcoesAdm__VariantsArgs;
  args: PlasmicOpcoesAdm__ArgsType;
  overrides: PlasmicOpcoesAdm__OverridesType;
  ...
  return (
    <PlasmicOpcoesAdmContext.Provider value={{ variants, args }}>
      <div
        ...
        >
          ...
          {p.renderPlasmicSlot({
            defaultContents: (
              <p.PlasmicImg
                alt={""}
                className={classNames(sty.img__fnLnC)}
    ...
    </PlasmicOpcoesAdmContext.Provider>
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <OpcoesAdm__Option
            className={classNames("__wab_instance", sty.option__xjusS)}
            value={"value1" as const}
          >
            {"Adicionar Amigo"}
          </OpcoesAdm__Option>
          ...
          <OpcoesAdm__Option
            className={classNames("__wab_instance", sty.option__wHd9F)}
            value={"value2" as const}
          >
            {"Remover"}
          </OpcoesAdm__Option>
...
type NodeDefaultElementType = {
  ...
  dropdownIcon: "svg";
  overlay: typeof OpcoesAdm__Overlay;
  optionsContainer: "div";
};

type ReservedPropsType = "variants" | "args" | "overrides";
type NodeOverridesType<T extends NodeNameType> = Pick<
  PlasmicOpcoesAdm__OverridesType,
  DescendantsType<T>
>;
type NodeComponentProps<T extends NodeNameType> =
  ...
  } & Omit<PlasmicOpcoesAdm__VariantsArgs, ReservedPropsType> & // Specify variants directly as props
    // Specify args directly as props
    Omit<PlasmicOpcoesAdm__ArgsType, ReservedPropsType> &
...
function makeNodeComponent<NodeName extends NodeNameType>(nodeName: NodeName) {
    ...
    const { variants, args, overrides } = React.useMemo(
      () =>
        deriveRenderOpts(props, {
          ...
          internalArgPropNames: PlasmicOpcoesAdm__ArgProps,
          internalVariantPropNames: PlasmicOpcoesAdm__VariantProps
        }),
      [props, nodeName]
    );

    return PlasmicOpcoesAdm__RenderFunc({
      variants,
      args,
      overrides,
      forNode: nodeName
  ...
  if (nodeName === "root") {
    func.displayName = "PlasmicOpcoesAdm";
  } else {
    func.displayName = `PlasmicOpcoesAdm.${nodeName}`;
  }
  return func;
}

export const PlasmicOpcoesAdm = Object.assign(
  // Top-level PlasmicOpcoesAdm renders the root element
  makeNodeComponent("root"),
  {
    ...
    // Metadata about props expected for PlasmicOpcoesAdm
    internalVariantProps: PlasmicOpcoesAdm__VariantProps,
    internalArgProps: PlasmicOpcoesAdm__ArgProps,

    // Context for sub components
    Context: PlasmicOpcoesAdmContext,

    useBehavior
  }
);

export default PlasmicOpcoesAdm;
/* prettier-ignore-end */
